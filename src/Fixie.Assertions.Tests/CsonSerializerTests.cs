...
class CsonSerializerTests
{
    ...
    public void ShouldSerializeTypes()
    {
        ...
        Action unsupported = () => Serialize(typeof(int));
        
        unsupported.ShouldThrow<NotSupportedException>("Serialization and deserialization of 'System.Type' instances is not supported. Path: $.");
    }
